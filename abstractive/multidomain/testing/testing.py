...
class Summarizer(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        return {'test_loss': loss, 'input_text': input_text, 'pred_text': pred_text, 'ref_text': ref_text, 'domain': domain}
    ...
    def test_epoch_end(self, outputs):
        ...
        model_nm = model_name.split('/')[-1].split('-')[0]
        df_to_write.to_csv(f'{method}/{model_nm}_predictions/lang_wise_{method}_{lang}_{model_nm}.csv', index=False)
...
if __name__ == "__main__":
    ...
    print('-----------------------------------------------------------------------------------------------------------')
    print(method, lang, model_name)
    train_path = 'multidomain_data/' + method + '_output_data/' + lang + '/' + lang + '_train.json'
    val_path = 'multidomain_data/' + method + '_output_data/' + lang + '/' + lang + '_val.json'
    test_path = 'multidomain_data/' + method + '_output_data/' + lang + '/' + lang + '_test.json'
